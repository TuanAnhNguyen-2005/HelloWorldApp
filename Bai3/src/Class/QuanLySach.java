...
public class QuanLySach {
	// thuoc tinh
	private ArrayList<TaiLieu> dstl341;

	// phuong thuc
	// ham khoi tao
	public QuanLySach() {
		dstl341 = new ArrayList<TaiLieu>(10);
	}
	...
	public void timMaTL(String maTaiLieu341) {
		for (TaiLieu tl : dstl341) {
			if (maTaiLieu341.equals(tl.getMaTaiLieu341())) {
				tl.hienThiThongTin();
			}
		}
	}
